...
var ship=L.shipPreset(id),p={ship:id,x:210,y:128+Math.sin(time*2)*2};
ctx.save();ctx.translate(p.x,p.y);ctx.scale(1.7,1.7);R.drawPlayer(ctx,{ship:id,x:0,y:0},time);ctx.restore();
